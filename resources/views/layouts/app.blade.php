            ...
            <x-mary-menu active-class="sidebar-item-active" class="px-6 space-y-3">
                ...
                <x-mary-menu-sub title="Expedientes" icon="o-folder" open="{{ request()->routeIs('expedients.*') }}" class="text-slate-600 dark:text-white/70 font-black text-sm">
                    ...
                    @can('expedients.create')
                        ...
                        <x-mary-menu-item title="Alta Continua" icon="o-queue-list" link="{{ route('expedients.continuous-create') }}" active="{{ request()->routeIs('expedients.continuous-create') }}" badge="Piloto" badge-classes="badge-info font-black text-[9px]" class="text-xs font-bold py-3" />
                    @endcan
                </x-mary-menu-sub>
                @endcan
