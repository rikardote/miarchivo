<div @if($is_auditing) wire:poll.800ms="checkRemoteGunAuditScans" @endif class="space-y-6" x-data="{
    ...
    {{-- HEADER PRINCIPAL --}}
    <x-page-header title="Auditoría de Inventario" subtitle="Conciliación física en tiempo real de expedientes por gaveta y estantería" icon="o-clipboard-document-check">
        <x-slot:actions>
            @if($is_auditing)
                <button 
                    type="button" 
